...
public:
    ...
    gateway::BWRateLimiterInterface::Ptr rateLimitInterface() override
    {
        return m_rateLimitInterface;
    }

    void setRateLimitInterface(gateway::BWRateLimiterInterface::Ptr _rateLimiterInterface)
    {
...
private:
    ...
    // rate limiter
    gateway::BWRateLimiterInterface::Ptr m_rateLimitInterface = nullptr;
};
