...
*/
class TransferPrecompiled : public dev::blockverifier::Precompiled
{
public:
    typedef std::shared_ptr<TransferPrecompiled> Ptr;
    TransferPrecompiled();
    virtual ~TransferPrecompiled(){};
...
private:
    ...
    std::pair<bool, int64_t> stringTime2TimeT(const std::string& _s);
    ...
    bytes createUser(dev::blockverifier::ExecutiveContext::Ptr _context, Address const& _origin,
        bytesConstRef _data, const std::string& _status, bool errorRet = false);

private:
    // user operation
    bytes createUser(dev::blockverifier::ExecutiveContext::Ptr _context, bytesConstRef _data,
        Address const& _origin);
    bytes createUser0(dev::blockverifier::ExecutiveContext::Ptr _context, bytesConstRef _data,
        Address const& _origin);
...
private:
    ...
    int32_t doTransfer(dev::blockverifier::ExecutiveContext::Ptr _context, Address const& _origin,
        const std::string& _from, const std::string& _to, const u256& _amount,
