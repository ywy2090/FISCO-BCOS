...
bool PrecompiledMap::contains(std::string const& key, uint32_t version, bool isAuth,
...
// Ethereum builtin precompiles: see bcos-evm/eth/precompiled/BuiltinPrecompiles.cpp
