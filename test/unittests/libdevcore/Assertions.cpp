...
BOOST_AUTO_TEST_CASE(testAsserts)
{
    ...
    int a = 10;
    int b = 11;
    BOOST_TEST(asserts(a == b) == true);
    BOOST_TEST(asserts(a > b) == true);
    BOOST_TEST(asserts(a < b) == false);
    BOOST_TEST(asserts(a == a) == false);
    // math test
    BOOST_TEST(asserts(a + b == 21) == false);
    BOOST_TEST(asserts(a + b == 22) == true);
    // pointer test
    char* str = nullptr;
    BOOST_TEST(asserts(str) == true);
    const char* str2 = "hello, test";
    BOOST_TEST(asserts(str2) == false);
}

/// test micro "assertsEqual"
BOOST_AUTO_TEST_CASE(testAssertsEqual)
{
    BOOST_TEST(assertsEqual(10, 10) == false);
    BOOST_TEST(assertsEqual('a', 'a') == false);
    BOOST_TEST(assertsEqual(10, 11) == true);
    BOOST_TEST(assertsEqual('a', 'b') == true);
    std::string str1 = "abcd";
    std::string str2 = "bcde";
    BOOST_TEST(assertsEqual(str1, str2) == true);
    str2 = "abcd";
    BOOST_TEST(assertsEqual(str1, str2) == false);
}
...
BOOST_AUTO_TEST_CASE(testAssertAux)
{
    ...
    BOOST_TEST(assertAux(true, str, line, file, func) == false);
    BOOST_TEST(assertAux(false, str, line, file, func) == true);
    BOOST_TEST(assertAux(true, "a + b == 10", __LINE__, __FILE__, ETH_FUNC) == false);
    BOOST_TEST(assertAux(false, "a + b == 10", __LINE__, __FILE__, ETH_FUNC) == true);
}
...
BOOST_AUTO_TEST_CASE(testAssertEqualAux)
{
    ...
    BOOST_TEST(assertEqualAux(a, b, aStr, bStr, line, file, func) == false);
    BOOST_TEST(assertEqualAux(a, b, aStr, bStr, __LINE__, __FILE__, ETH_FUNC) == false);
}
