...
// Round-11 F3: set_code with an empty mirror list is allowed at this gate once the 0x04
// authorization tuples are envelope-bound; empty-list rejection is opValidate's job.
