 ...
 *
 * @brief Block execution context helpers backed by protocol headers and ledger storage.
 * @file LedgerBlockInfo.h
 */
...
inline BlockInfo buildBlockInfoFromHeader(
...
BlockHashes buildBlockHashesFromStorage(Storage& storage, int64_t currentBlockNumber)
{
