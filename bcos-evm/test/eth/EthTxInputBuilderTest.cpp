#define BOOST_TEST_MODULE EthTxInputBuilderTest

#include "../../../transaction-executor/bcos-transaction-executor/EthTxInputBuilder.h"
...
BOOST_AUTO_TEST_SUITE(EthTxInputBuilderTest)
...
BOOST_AUTO_TEST_CASE(fillWeb3Fields_maps_eip7702_authorizations)
{
    ...
    eth_tx::fillWeb3Fields(tx, input);
