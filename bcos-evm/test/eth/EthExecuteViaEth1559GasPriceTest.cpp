/*
 * EIP-1559: executeViaEth normalizes gasPrice before EVM so GASPRICE matches geth.
 */
...
BOOST_AUTO_TEST_CASE(executeViaEth_type2_normalizes_gas_price_for_gasprice_opcode)
{
