...
**Status:** Accepted  
**Date:** 2026-06-26  
**Related:** ADR-005, ADR-019, ADR-024, `eth/pipeline/StateTransitionContext.h`, `eth/pipeline/BuildExecuteMessageInput.h`, `eth/execution/InnerExecute.h`, `eth/execution/EvmCallFrame.h`, `eth/state/EthHost.hpp`, `bcos/ApplyFiscoMessage.cpp`, `opstack/OpStackTxLifecycle.cpp`, `eth/apply/ApplyReferenceMessage.cpp`
