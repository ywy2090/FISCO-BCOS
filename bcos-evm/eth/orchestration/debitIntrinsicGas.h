...
struct DebitIntrinsicGasOutcome
{
    bool ok{false};
...
inline DebitIntrinsicGasOutcome debitIntrinsicGas(
    evmc_message& message, IntrinsicGasPolicy const& policy)
{
    DebitIntrinsicGasOutcome outcome{};
    outcome.ok = true;
