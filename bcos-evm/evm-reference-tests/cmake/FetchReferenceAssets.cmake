...
if(BCOS_EVM_REFERENCE_TESTS_FETCH_ASSETS)
    ...
    elseif(DEFINED ENV{ETHEREUM_TESTS_ROOT})
        ...
        message(FATAL_ERROR
            "BCOS_EVM_REFERENCE_TESTS_FETCH_ASSETS=OFF but GeneralStateTests not found under "
    ...
    elseif(DEFINED ENV{EEST_ROOT})
        ...
        message(FATAL_ERROR
            "BCOS_EVM_REFERENCE_TESTS_FETCH_ASSETS=OFF but EEST fixtures not found under "
...
message(STATUS "evm-reference-tests ethereum/tests root: ${EVM_REF_ETHEREUM_TESTS_ROOT}")
message(STATUS "evm-reference-tests EEST root: ${EVM_REF_EEST_ROOT}")
