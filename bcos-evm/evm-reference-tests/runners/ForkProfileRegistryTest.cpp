...
{
    BOOST_CHECK(!ForkProfileRegistry::instance().findByProfileId("eth-osaka").has_value());
    BOOST_CHECK(!ForkProfileRegistry::instance().findByUpstreamFork("Osaka").has_value());
}
