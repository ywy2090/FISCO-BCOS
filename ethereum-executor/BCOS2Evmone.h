...
inline evmone::state::Transaction bcosTransactionToEvmone(protocol::Transaction const& tx)
{
...
inline protocol::TransactionReceipt::Ptr evmoneReceiptToBcos(
    evmone::state::TransactionReceipt const& er, protocol::TransactionReceiptFactory const& rf,
    int64_t blockNumber)
{
